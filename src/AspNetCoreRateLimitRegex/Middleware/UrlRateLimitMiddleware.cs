...
{
    public class UrlRateLimitMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<UrlRateLimitMiddleware> _logger;
        private readonly UrlRateLimitProcessor _processor;
        ...
        {
            var message = string.IsNullOrEmpty(_options.QuotaExceededMessage) 
                ? $"API calls quota exceeded for rule {rule.UrlRegex}!\n maximum admitted {rule.Limit} per {rule.Period}." 
